package com.erongdu.server.generator.helper;

import com.alibaba.fastjson.JSONObject;
import com.erongdu.common.core.annotation.Helper;
...
import com.erongdu.server.generator.entity.FieldType;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(CommonUtil.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        JSONObject data = toJsonObject(configure);
        columns.forEach(c -> c.setField(CommonUtil.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        data.put("columns", columns);
    ...
    private Template getTemplate(String templateName) throws Exception {
        ...
        if (!file.exists()) {
            templatePath = System.getProperties().getProperty(CommonConstant.JAVA_TEMP_DIR);
        ...
        configuration.setDefaultEncoding(CommonConstant.UTF8);
