...
import com.erongdu.common.core.entity.FebsResponse;
import com.erongdu.common.core.entity.QueryRequest;
import com.erongdu.common.core.exception.FebsException;
...
public class ${className}Controller {
    ...
    public FebsResponse ${className?uncap_first}List(QueryRequest request, ${className} ${className?uncap_first}) {
        Map<String, Object> dataTable = CommonUtil.getDataTable(this.${className?uncap_first}Service.find${className}s(request, ${className?uncap_first}));
