...
public class MenuController {
    ...
    @GetMapping("/{username}")
    public CommonResponse getUserRouters(@NotBlank(message = "{required}") @PathVariable String username) {
    ...
    @GetMapping
    public CommonResponse menuList(Menu menu) {
        Map<String, Object> menus = this.menuService.findMenus(menu);
        return new CommonResponse().data(menus);
    }
