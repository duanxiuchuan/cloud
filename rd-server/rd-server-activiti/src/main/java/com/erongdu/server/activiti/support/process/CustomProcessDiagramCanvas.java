package com.erongdu.server.activiti.support.process;
    ...
    public BufferedImage generateBufferedImage(String imageType) {
        ...
        if (minX >= 0 && minY >= 0) {
            imageToSerialize = processDiagram.getSubimage(
                    minX - ActivitiConstant.PROCESS_PADDING,
                    minY - ActivitiConstant.PROCESS_PADDING,
                    canvasWidth - minX + ActivitiConstant.PROCESS_PADDING,
