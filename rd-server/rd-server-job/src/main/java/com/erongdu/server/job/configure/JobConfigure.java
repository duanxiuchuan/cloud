package com.erongdu.server.job.configure;
...
public class JobConfigure {
    ...
    public ThreadPoolTaskExecutor scheduleJobExecutorService() {
        ...
        executor.setThreadNamePrefix("Rd-Job-Thread");
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "RdCloudScheduler");
        ...
        factory.setSchedulerName("Rd_Cloud_Scheduler");
        // 延时启动
