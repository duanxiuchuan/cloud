package com.erongdu.auth.manager;
...
import com.erongdu.auth.mapper.MenuMapper;
import com.erongdu.auth.mapper.UserMapper;
import com.erongdu.auth.mapper.UserRoleMapper;
...
public class UserManager {
    ...
    public SystemUser registUser(String username, String password) {
        ...
        // 注册用户角色 ID
        userRole.setRoleId(CommonConstant.REGISTER_ROLE_ID);
